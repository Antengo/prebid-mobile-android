package com.sellwild.prebid.prebidkotlindemo.activities.ads.gam.original
...
import com.sellwild.prebid.addendum.AdViewUtils.PbFindSizeListener
...
import com.sellwild.prebid.prebidkotlindemo.activities.BaseAdActivity
...
class GamOriginalApiMultiformatBannerVideoNativeStylesActivity : BaseAdActivity() {
    ...
    private fun createBannerParameters(): BannerParameters {
        ...
        params.adSizes = mutableSetOf(com.sellwild.prebid.AdSize(300, 250))
        return params
    }

    private fun createVideoParameters(): VideoParameters {
        val params = VideoParameters(listOf("video/mp4"))
        params.adSize = com.sellwild.prebid.AdSize(320, 480)
        return params
    }
