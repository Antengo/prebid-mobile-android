...
import com.sellwild.prebid.InStreamVideoAdUnit;
...
public class GamOriginalApiVideoInStream extends BaseAdActivity {
    ...
    private void createAd() {
        ...
        adUnit.fetchDemand((bidInfo) -> {
            HashSet<com.sellwild.prebid.AdSize> sizes = new HashSet<>();
            sizes.add(new com.sellwild.prebid.AdSize(WIDTH, HEIGHT));
