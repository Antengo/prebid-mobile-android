package com.sellwild.prebid.javademo.activities.ads.gam.original;
...
import com.sellwild.prebid.NativeAsset;
...
import com.sellwild.prebid.PrebidNativeAdListener;
import com.sellwild.prebid.VideoParameters;
import com.sellwild.prebid.addendum.AdViewUtils;
import com.sellwild.prebid.addendum.PbFindSizeError;
import com.sellwild.prebid.api.original.PrebidAdUnit;
import com.sellwild.prebid.api.original.PrebidRequest;
import com.sellwild.prebid.javademo.R;
import com.sellwild.prebid.javademo.activities.BaseAdActivity;
import com.sellwild.prebid.javademo.utils.ImageUtils;
...
public class GamOriginalApiMultiformatBannerVideoNativeInApp extends BaseAdActivity {
    ...
    private BannerParameters createBannerParameters() {
        ...
        parameters.setAdSizes(Sets.newHashSet(new com.sellwild.prebid.AdSize(300, 250)));
        return parameters;
    }

    private VideoParameters createVideoParameters() {
        VideoParameters parameters = new VideoParameters(Lists.newArrayList("video/mp4"));
        parameters.setAdSize(new com.sellwild.prebid.AdSize(320, 480));
        return parameters;
    }
