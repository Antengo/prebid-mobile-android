...
package com.sellwild.prebid.prebidnextgendemo
...
class CustomApplication : Application() {
    ...
    private fun initPrebidSDK() {
        ...
        SellwildPrebid.initializeSdk(applicationContext, "https://prebid-server-test-j.prebid.org/openrtb2/auction") { status ->
