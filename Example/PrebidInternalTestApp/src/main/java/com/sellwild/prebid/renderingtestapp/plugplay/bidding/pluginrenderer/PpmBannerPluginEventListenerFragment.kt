...
package com.sellwild.prebid.renderingtestapp.plugplay.bidding.pluginrenderer
...
import com.sellwild.prebid.renderingtestapp.utils.SampleCustomRenderer
import com.sellwild.prebid.renderingtestapp.utils.SampleCustomRendererEventListener
...
open class PpmBannerPluginEventListenerFragment : AdFragment(), BannerViewListener, SampleCustomRendererEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        SellwildPrebid.registerPluginRenderer(sampleCustomRenderer)
    }
    ...
    override fun onDestroy() {
        SellwildPrebid.unregisterPluginRenderer(sampleCustomRenderer)
        super.onDestroy()
    }
}