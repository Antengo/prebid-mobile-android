...
package com.sellwild.prebid.renderingtestapp.plugplay.bidding
...
import com.sellwild.prebid.renderingtestapp.data.DemoItem
import com.sellwild.prebid.renderingtestapp.databinding.FragmentMainBinding
import com.sellwild.prebid.renderingtestapp.utils.BaseFragment
import com.sellwild.prebid.renderingtestapp.utils.GdprHelper
import com.sellwild.prebid.renderingtestapp.utils.SegmentAdapterReImpl
import com.sellwild.prebid.renderingtestapp.utils.adapters.DemoItemClickListener
import com.sellwild.prebid.renderingtestapp.utils.adapters.DemoListAdapter
...
class HeaderBiddingFragment : BaseFragment() {
    ...
    private fun initCacheSwitch() {
        ...
        switch.isChecked = SellwildPrebid.isUseCacheForReportingWithRenderingApi()
        switch.setOnCheckedChangeListener { _, isChecked ->
            SellwildPrebid.setUseCacheForReportingWithRenderingApi(isChecked)
        }
    }
