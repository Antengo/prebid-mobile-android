...
import com.sellwild.prebid.renderingtestapp.databinding.FragmentBiddingBannerVideoBinding
...
class GamOriginalInstreamFragment : AdFragment() {
    ...
    override fun initAd(): Any? {
        SellwildPrebid.setPrebidServerAccountId("1001")
        SellwildPrebid.initializeSdk(context, "https://prebid-server.rubiconproject.com/openrtb2/auction", null);
        createAd()
        return null
    }
    ...
    override fun onDestroyView() {
        ...
        adsLoader?.release()
        player?.release()
        SellwildPrebid.initializeSdk(context, "https://prebid-server-test-j.prebid.org/openrtb2/auction", null);
