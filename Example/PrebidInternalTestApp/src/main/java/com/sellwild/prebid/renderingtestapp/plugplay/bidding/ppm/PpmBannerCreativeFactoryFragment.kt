...
class PpmBannerCreativeFactoryFragment : PpmBannerFragment() {
    ...
    override fun onAdLoaded(bannerView: BannerView?) {
        if (SellwildPrebid.getCreativeFactoryTimeout() == DEFAULT_CREATIVE_FACTORY_TIMEOUT ||
            SellwildPrebid.getCreativeFactoryTimeoutPreRenderContent() == DEFAULT_CREATIVE_FACTORY_TIMEOUT_PRERENDER_CONTENT) {
            events.failed(true)
        } else {
