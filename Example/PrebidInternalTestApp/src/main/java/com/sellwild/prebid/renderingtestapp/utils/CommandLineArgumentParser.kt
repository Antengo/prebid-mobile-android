...
import com.sellwild.prebid.ExternalUserId.UniqueId
import com.sellwild.prebid.SellwildPrebid
import com.sellwild.prebid.TargetingParams
import com.sellwild.prebid.api.mediation.MediationBaseAdUnit
import com.sellwild.prebid.api.mediation.MediationNativeAdUnit
import com.sellwild.prebid.api.rendering.BannerView
import com.sellwild.prebid.api.rendering.BaseInterstitialAdUnit
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.Ext
import com.sellwild.prebid.renderingtestapp.plugplay.utilities.consent.ConsentUpdateManager
...
object CommandLineArgumentParser {
    ...
    fun parse(intent: Intent?, context: Context) {
        ...
        extras.getBoolean("shareGeo").let { shareGeo ->
            SellwildPrebid.setShareGeoLocation(shareGeo)
        }
