...
class SampleCustomRenderer : SellwildPrebidPluginRenderer {
    ...
    override fun createInterstitialController(
        ...
        adUnitConfiguration: AdUnitConfiguration,
        bidResponse: BidResponse
    ): SellwildPrebidInterstitialControllerInterface {
        ...
        return object : SellwildPrebidInterstitialControllerInterface {
