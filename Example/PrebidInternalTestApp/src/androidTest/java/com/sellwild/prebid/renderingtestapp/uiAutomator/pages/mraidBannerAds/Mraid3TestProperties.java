...
package com.sellwild.prebid.renderingtestapp.uiAutomator.pages.mraidBannerAds;
...
public class Mraid3TestProperties extends MraidBasicPage {
    ...
    public Mraid3TestProperties checkMraidEnv() throws JSONException {
        ...
        envJson.put("version", SellwildPrebid.MRAID_VERSION);
        envJson.put("sdk", SellwildPrebid.SDK_NAME);
        envJson.put("sdkVersion", SellwildPrebid.SDK_VERSION);
    ...
    private static class Locators {
        ...
        static BySelector closeButton = By.res("com.sellwild.prebid.renderingtestapp:id/iv_close_interstitial");
