package com.sellwild.prebid.drprebid.validation;
...
import com.sellwild.prebid.drprebid.async.DemandTestResultTask;
import com.sellwild.prebid.drprebid.async.DemandTestTask;
import com.sellwild.prebid.drprebid.managers.DemandTestManager;
import com.sellwild.prebid.drprebid.managers.SettingsManager;
import com.sellwild.prebid.drprebid.model.AdSize;
import com.sellwild.prebid.drprebid.model.*;
...
public class RealTimeDemandTest {
    ...
    public void startTest() {
        ...
        switch (prebidServerSettings.getPrebidServer()) {
            case APPNEXUS:
                SellwildPrebid.setPrebidServerHost(Host.APPNEXUS);
                hostUrl = Constants.EndpointUrls.APPNEXUS_PREBID_SERVER;
                break;
            case RUBICON:
                SellwildPrebid.setPrebidServerHost(Host.RUBICON);
                hostUrl = Constants.EndpointUrls.RUBICON_PREBID_SERVER;
                break;
            case CUSTOM:
                SellwildPrebid.setPrebidServerHost(Host.CUSTOM);
        ...
        SellwildPrebid.initializeSdk(context, null);
