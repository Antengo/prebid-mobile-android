...
import com.sellwild.prebid.reflection.sdk.UserConsentManagerReflection;
...
public class TargetingParamsTest extends BaseSetup {
    ...
    public void testBundleName() throws Exception {
        ...
        when(mockContext.getPackageName()).thenReturn("com.sellwild.prebid.core.test");

        assertEquals("com.sellwild.prebid.core.test", TargetingParams.getBundleName());
        TargetingParams.setBundleName("com.sellwild.prebid");
        assertEquals("com.sellwild.prebid", TargetingParams.getBundleName());
    }
