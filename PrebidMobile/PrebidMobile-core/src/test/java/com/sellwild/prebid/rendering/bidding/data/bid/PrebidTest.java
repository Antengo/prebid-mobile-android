...
public class PrebidTest {
    ...
    public void tearDown(){
        SellwildPrebid.setIncludeBidderKeysFlag(false);
        SellwildPrebid.setIncludeWinnersFlag(false);
    ...
    public void whenGetJsonObjectForImp_BidResponseEqualsExpected() throws JSONException {
        ...
        SellwildPrebid.addStoredBidResponse("bidderTest", "98765");
        SellwildPrebid.addStoredBidResponse("bidderTest2", "12345");
    ...
    public void includeBiddersKeys_EqualsTrue() throws JSONException {
        SellwildPrebid.setIncludeBidderKeysFlag(true);
    ...
    public void includeWinners_EqualsTrue() throws JSONException {
        SellwildPrebid.setIncludeWinnersFlag(true);
