...
import static com.sellwild.prebid.api.rendering.BaseInterstitialAdUnit.InterstitialAdUnitState.*;
...
public class InterstitialAdUnitTest {
    ...
    public void onFailedAndWithWinnerBid_ExecuteInterstitialControllerLoadAd() {
        ...
        when(mockBidResponse.getWinningBid()).thenReturn(mockBid);
        SellwildPrebidPluginRenderer fakePrebidRenderer = FakeSellwildPrebidPluginRenderer.getFakePrebidRenderer(mockInterstitialController, null, true, PREBID_MOBILE_RENDERER_NAME, "1.0");
        SellwildPrebid.registerPluginRenderer(fakePrebidRenderer);
