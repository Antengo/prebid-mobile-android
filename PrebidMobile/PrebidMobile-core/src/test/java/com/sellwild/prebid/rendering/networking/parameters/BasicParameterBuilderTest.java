...
import static com.sellwild.prebid.rendering.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_NAME;
import static com.sellwild.prebid.rendering.networking.parameters.BasicParameterBuilder.KEY_OM_PARTNER_VERSION;
import static com.sellwild.prebid.rendering.networking.parameters.BasicParameterBuilder.VIDEO_INTERSTITIAL_PLAYBACK_END;
...
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.Imp;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.Native;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.PluginRendererList;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.User;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.devices.Geo;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.imps.Banner;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.imps.Video;
import com.sellwild.prebid.rendering.models.openrtb.bidRequests.source.Source;
import com.sellwild.prebid.rendering.sdk.ManagersResolver;
import com.sellwild.prebid.rendering.session.manager.OmAdSessionManager;
import com.sellwild.prebid.rendering.utils.helpers.Utils;
import com.sellwild.prebid.rendering.video.vast.Ad;
...
public class BasicParameterBuilderTest {
    ...
    private SellwildPrebidPluginRenderer otherPlugin = FakeSellwildPrebidPluginRenderer.getFakePrebidRenderer(null, null, true, "FakePlugin", "1.0");
    ...
    public void cleanup() throws Exception {
        ...
        SellwildPrebid.setStoredAuctionResponse(null);
        SellwildPrebid.setPrebidServerAccountId("");
        SellwildPrebid.setAuctionSettingsId(null);

        SellwildPrebid.unregisterPluginRenderer(otherPlugin);
    }
    ...
    public void sourceOmidValues_renderingApi_defaultValues() throws JSONException {
        ...
        assertEquals(SellwildPrebid.SDK_VERSION, sourceExtJson.getString("omidpv"));
    }
    ...
    public void whenAppendParametersAndBannerType_ImpWithValidBannerObject() throws JSONException {
        ...
        SellwildPrebid.addStoredBidResponse("bidderTest", "123456");
        SellwildPrebid.setStoredAuctionResponse("storedResponse");
    ...
    public void whenSetPluginRendererList_pluginRendererIsIndexed() throws JSONException {
        // Given
        SellwildPrebid.registerPluginRenderer(otherPlugin);
        AdUnitConfiguration configuration = new AdUnitConfiguration();
        configuration.setIsOriginalAdUnit(false);
        configuration.setAdFormat(AdFormat.BANNER);
        ...
        assertEquals(((JSONObject)renderersObj.get(1)).get("name"), SellwildPrebidPluginRegister.PREBID_MOBILE_RENDERER_NAME);
    }
    ...
    public void whenSetAuctionSettingsId_storedRequestIdEqualsToTheAuctionsSettingsId() throws JSONException {
        ...
        SellwildPrebid.setAuctionSettingsId(expectedStoredRequestId);
        SellwildPrebid.setPrebidServerAccountId(serverAccountId);
        ...
        assertNotNull(SellwildPrebid.getAuctionSettingsId());
    ...
    public void whenSetOnlyServerAccountId_storedRequestIdEqualsToTheServerAccountId() throws JSONException {
        ...
        assertNull(SellwildPrebid.getAuctionSettingsId());
    ...
    public void whenSetInvalidAuctionSettingsId_storedRequestIdEqualsToTheServerAccountId() throws JSONException {
        ...
        SellwildPrebid.setAuctionSettingsId(settingsId);
        SellwildPrebid.setPrebidServerAccountId(serverAccountId);
    ...
    private BidRequest getExpectedBidRequest(
        ...
        bidRequest.getExt().put(
                "prebid",
                Prebid.getJsonObjectForBidRequest(SellwildPrebid.getPrebidServerAccountId(), isVideo, adConfiguration)
        );
    ...
    private Imp getExpectedImp(AdUnitConfiguration adConfiguration, String uuid) {
        ...
        imp.displaymanagerver = SellwildPrebid.SDK_VERSION;
