...
@LooperMode(LEGACY)
public class SellwildPrebidTest {
    ...
    public void testOnSDKInitWithoutVideoPreCache() throws Exception {
        ...
        SellwildPrebid.initializeSdk(context, url.toString().replace("/status", "/openrtb2/auction"), mockSdkInitListener);
    ...
    public void setStoreAuctionResponse_EqualsGetStoredAuctionResponse() {
        ...
        SellwildPrebid.setStoredAuctionResponse(expected);
        assertEquals(expected, SellwildPrebid.getStoredAuctionResponse());
    }
    ...
    public void addAndClearStoredBidResponseMap_ReturnExpectedResult() {
        ...
        SellwildPrebid.addStoredBidResponse("bidder1", "1111");
        SellwildPrebid.addStoredBidResponse("bidder2", "2222");

        assertEquals(expectedMap, SellwildPrebid.getStoredBidResponses());
