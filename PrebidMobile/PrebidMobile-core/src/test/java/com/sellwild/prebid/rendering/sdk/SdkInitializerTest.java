package com.sellwild.prebid.rendering.sdk;
...
public class SdkInitializerTest {
    ...
    private void reset() {
        ...
        error = null;
        serverWarning = null;
        SellwildPrebidReflection.setHost("");
        ...
        Reflection.setStaticVariableTo(SellwildPrebid.class, "disableStatusCheck", false);
    }
    ...
    public void init_putNullContextAndNullListener_initializationFail() {
        ...
        assertFalse(SellwildPrebid.isSdkInitialized());
    }
    ...
    public void init_statusResponseIsOk_initializationIsSuccessful() throws IOException, InterruptedException {
        ...
        assertTrue(SellwildPrebid.isSdkInitialized());
        assertNull(error);
    }
    ...
    public void init_customStatusResponseIsOk_initializationIsSuccessful() throws IOException, InterruptedException {
        ...
        assertTrue(isSuccessful);
        assertTrue(SellwildPrebid.isSdkInitialized());
        assertTrue(SellwildPrebidPluginRegister.getInstance().containsPlugin(PREBID_MOBILE_RENDERER_NAME));
        assertNull(error);
    }
    ...
    public void runBackgroundTasks_checkStartedTasks() throws InterruptedException {
        ...
        MatcherAssert.assertThat(requesterClassName, is(startsWith("class com.sellwild.prebid.rendering.sdk.StatusRequester")));
        ...
        MatcherAssert.assertThat(firstTaskName, is(startsWith("class com.sellwild.prebid.rendering.sdk.SdkInitializer$UserConsentFetcherTask")));

        String secondTaskName = allTasks.get(1).getClass().toString();
        MatcherAssert.assertThat(secondTaskName, is(startsWith("class com.sellwild.prebid.rendering.sdk.UserAgentFetcherTask")));
    ...
    public void runBackgroundTasks_checkStartedTasks_disableStatusCheck() throws InterruptedException, ExecutionException {
        SellwildPrebidReflection.setDisableStatusCheckToTrue();
