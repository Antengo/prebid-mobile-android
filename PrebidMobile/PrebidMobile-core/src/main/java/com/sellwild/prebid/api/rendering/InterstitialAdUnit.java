...
import com.sellwild.prebid.api.rendering.listeners.InterstitialAdUnitListener;
...
import com.sellwild.prebid.rendering.bidding.interfaces.InterstitialEventHandler;
import com.sellwild.prebid.rendering.bidding.interfaces.StandaloneInterstitialEventHandler;
import com.sellwild.prebid.rendering.bidding.listeners.InterstitialEventListener;
import com.sellwild.prebid.rendering.utils.helpers.RenderingExceptionParser;

import java.util.EnumSet;

import static com.sellwild.prebid.api.rendering.BaseInterstitialAdUnit.InterstitialAdUnitState.READY_FOR_LOAD;
import static com.sellwild.prebid.api.rendering.BaseInterstitialAdUnit.InterstitialAdUnitState.READY_TO_DISPLAY_GAM;
...
public class InterstitialAdUnit extends BaseInterstitialAdUnit {
    ...
    public void setPluginEventListener(PluginEventListener pluginEventListener) {
        SellwildPrebidPluginRegister.getInstance().registerEventListener(pluginEventListener, config.getFingerprint());
    }
    ...
    public void destroy() {
        ...
        SellwildPrebidPluginRegister.getInstance().unregisterEventListener(config.getFingerprint());
    }
