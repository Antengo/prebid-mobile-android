...
package com.sellwild.prebid.rendering.utils.url.action;
...
import com.sellwild.prebid.rendering.utils.helpers.ExternalViewerUtils;
import com.sellwild.prebid.rendering.utils.helpers.Utils;
import com.sellwild.prebid.rendering.utils.url.ActionNotResolvedException;
import com.sellwild.prebid.rendering.utils.url.UrlHandler;
...
public class MraidInternalBrowserAction implements UrlAction {
    ...
    public boolean shouldOverrideUrlLoading(Uri uri) {
        ...
        return SellwildPrebid.SCHEME_HTTP.equals(scheme) || SellwildPrebid.SCHEME_HTTPS.equals(scheme);
    }
    ...
    void handleInternalBrowserAction(final Context context, BaseJSInterface baseJSInterface, String url) {
        baseJSInterface.followToOriginalUrl(url, new RedirectUrlListener() {
            ...
            public void onSuccess(String url, String contentType) {
                ...
                } else if (url != null && (url.startsWith(SellwildPrebid.SCHEME_HTTP) || url.startsWith(SellwildPrebid.SCHEME_HTTPS))) {
