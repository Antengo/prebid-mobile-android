...
public enum ResultCode {
    ...
    INVALID_SIZE,
    /**
     * Unable to obtain the Application Context, check if you have set it through SellwildPrebid.setApplicationContext()
     */
    INVALID_CONTEXT,
    /**
    ...
    /**
     * Check @{@link com.sellwild.prebid.api.original.PrebidRequest} object that you put into fetchDemand().
     */
