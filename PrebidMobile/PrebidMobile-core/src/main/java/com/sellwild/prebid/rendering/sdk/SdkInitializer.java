...
import com.sellwild.prebid.api.rendering.PrebidRenderer;
...
public class SdkInitializer {
    ...
    public static void init(
        ...
        if (SellwildPrebid.isSdkInitialized() || InitializationNotifier.isInitializationInProgress()) {
            return;
        }
        ...
        if (SellwildPrebid.getLogLevel() != null) {
            LogUtil.setLogLevel(SellwildPrebid.getLogLevel().getValue());
        }

        PrebidLogger customLogger = SellwildPrebid.getCustomLogger();
        if (customLogger != null) {
            LogUtil.setLogger(customLogger);
        }

        try {
            SellwildPrebid.registerPluginRenderer(new PrebidRenderer());
    ...
    public static void runBackgroundTasks(
        ...
        try {
            ...
            if (!SellwildPrebid.shouldDisableStatusCheck()) {
