...
package com.sellwild.prebid.rendering.loading;
...
import com.sellwild.prebid.rendering.models.AbstractCreative;
import com.sellwild.prebid.rendering.models.CreativeModel;
import com.sellwild.prebid.rendering.models.HTMLCreative;
import com.sellwild.prebid.rendering.models.TrackingEvent;
...
import com.sellwild.prebid.rendering.video.RewardedVideoCreative;
import com.sellwild.prebid.rendering.video.VideoAdEvent;
import com.sellwild.prebid.rendering.video.VideoCreative;
import com.sellwild.prebid.rendering.video.VideoCreativeModel;
import com.sellwild.prebid.rendering.video.vast.VASTErrorCodes;
...
public class CreativeFactory {
    ...
    private void attemptAuidCreative() throws Exception {
        ...
        long creativeDownloadTimeout = SellwildPrebid.getCreativeFactoryTimeout();
        if (creativeModel.getAdConfiguration().isAdType(AdFormat.INTERSTITIAL)) {
            creativeDownloadTimeout = SellwildPrebid.getCreativeFactoryTimeoutPreRenderContent();
        }
    ...
    private void attemptVastCreative() {
        ...
        try {
            ...
            markWorkStart(SellwildPrebid.getCreativeFactoryTimeoutPreRenderContent());
            newCreative.load();
        } catch (Exception exception) {
