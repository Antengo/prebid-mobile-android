...
package com.sellwild.prebid.rendering.parser;
...
import com.sellwild.prebid.rendering.errors.VastParseError;
import com.sellwild.prebid.rendering.networking.parameters.BasicParameterBuilder;
import com.sellwild.prebid.rendering.utils.helpers.Utils;
import com.sellwild.prebid.rendering.video.VideoAdEvent;
import com.sellwild.prebid.rendering.video.vast.Ad;
import com.sellwild.prebid.rendering.video.vast.AdVerifications;
import com.sellwild.prebid.rendering.video.vast.ClickTracking;
import com.sellwild.prebid.rendering.video.vast.Companion;
import com.sellwild.prebid.rendering.video.vast.Creative;
import com.sellwild.prebid.rendering.video.vast.Extension;
import com.sellwild.prebid.rendering.video.vast.Impression;
import com.sellwild.prebid.rendering.video.vast.InLine;
import com.sellwild.prebid.rendering.video.vast.MediaFile;
import com.sellwild.prebid.rendering.video.vast.VAST;
...
public class AdResponseParserVast extends AdResponseParserBase {
    ...
    private ArrayList<com.sellwild.prebid.rendering.video.vast.Tracking> trackings;
    private ArrayList<ClickTracking> clickTrackings;
    private ArrayList<Impression> impressions;

    private VAST vast;

    public ArrayList<com.sellwild.prebid.rendering.video.vast.Tracking> getTrackings() {
        return trackings;
    }
    ...
    public ArrayList<com.sellwild.prebid.rendering.video.vast.Tracking> getTrackingEvents(VAST vast, int index) {
    ...
    public ArrayList<com.sellwild.prebid.rendering.video.vast.Tracking> getAllTrackings(AdResponseParserVast parserVast, int index) {
    ...
    public ArrayList<String> getTrackingByType(VideoAdEvent.Event event) {
        Iterator<com.sellwild.prebid.rendering.video.vast.Tracking> iterator = trackings.iterator();

        ArrayList<String> urls = new ArrayList<>();

        while (iterator.hasNext()) {
            com.sellwild.prebid.rendering.video.vast.Tracking t = iterator.next();
     ...
     */
    public static com.sellwild.prebid.rendering.video.vast.Tracking findTracking(ArrayList<com.sellwild.prebid.rendering.video.vast.Tracking> trackingEvents) {
        if (trackingEvents != null) {
            for (com.sellwild.prebid.rendering.video.vast.Tracking tracking : trackingEvents) {
