...
import com.sellwild.prebid.api.original.OnFetchDemandResult;
...
public abstract class AdUnit {
    ...
    public void fetchDemand(Object adObject, @NonNull OnCompleteListener listener) {
        ...
        if (TextUtils.isEmpty(SellwildPrebid.getPrebidServerAccountId())) {
        ...
        if (SellwildPrebid.getPrebidServerHost().equals(Host.CUSTOM)) {
            if (TextUtils.isEmpty(SellwildPrebid.getPrebidServerHost().getHostUrl())) {
