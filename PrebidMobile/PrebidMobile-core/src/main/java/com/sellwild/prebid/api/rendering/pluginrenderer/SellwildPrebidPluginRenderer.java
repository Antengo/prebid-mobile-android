 ...
 */
public interface SellwildPrebidPluginRenderer {
    ...
    /**
     * Creates and returns an implementation of SellwildPrebidInterstitialControllerInterface for a given bid response
     * Returns null in the case of an internal error
     */
    SellwildPrebidInterstitialControllerInterface createInterstitialController(
            @NonNull Context context,
