...
import com.sellwild.prebid.LogUtil.PrebidLogger;
import com.sellwild.prebid.api.data.InitializationStatus;
import com.sellwild.prebid.api.rendering.pluginrenderer.SellwildPrebidPluginRegister;
...
import com.sellwild.prebid.rendering.listeners.SdkInitializationListener;
import com.sellwild.prebid.rendering.mraid.MraidEnv;
...
import com.sellwild.prebid.rendering.sdk.SdkInitializer;
...
public class SellwildPrebid {
    ...
    private static final String TAG = SellwildPrebid.class.getSimpleName();
    ...
    public static void setUseCacheForReportingWithRenderingApi(boolean useCacheForReportingWithRenderingApi) {
        SellwildPrebid.useCacheForReportingWithRenderingApi = useCacheForReportingWithRenderingApi;
    }
    ...
    public static void setTimeoutMillis(int timeoutMillis) {
        SellwildPrebid.timeoutMillis = timeoutMillis;
        SellwildPrebid.isTimeoutModified = true;
    }
    ...
    public static void setPrebidServerAccountId(String accountId) {
        SellwildPrebid.accountId = accountId;
    }
    ...
    public static void setAuctionSettingsId(String settingsId) {
        SellwildPrebid.auctionSettingsId = settingsId;
    }
    ...
    public static void setShareGeoLocation(boolean share) {
        SellwildPrebid.shareGeoLocation = share;
    }
    ...
    public static void setCustomHeaders(@Nullable HashMap<String, String> customHeaders) {
        if (customHeaders != null) {
            SellwildPrebid.customHeaders = customHeaders;
        }
    }
    ...
    public static HashMap<String, String> getCustomHeaders() {
        return SellwildPrebid.customHeaders;
    }

    /**
     * Initializes the main SDK classes and makes request to Prebid server to check its status.
     * If you use custom /status endpoint set it with ({@link SellwildPrebid#setCustomStatusEndpoint(String)}) before starting initialization.
     * <p>
    ...
    public static void initializeSdk(
        ...
        SellwildPrebid.host = Host.createCustomHost(serverURL);
    ...
    public static void setStoredAuctionResponse(@Nullable String storedAuctionResponse) {
        SellwildPrebid.storedAuctionResponse = storedAuctionResponse;
    }
    ...
    public static void setPbsDebug(boolean pbsDebug) {
        SellwildPrebid.pbsDebug = pbsDebug;
    }
    ...
    public static void assignNativeAssetID(boolean assignNativeAssetID) {
        SellwildPrebid.assignNativeAssetID = assignNativeAssetID;
    }
    ...
    public static LogLevel getLogLevel() {
        return SellwildPrebid.logLevel;
    }
    ...
    public static void setLogLevel(LogLevel logLevel) {
        SellwildPrebid.logLevel = logLevel;
    }
    ...
    public static PrebidLogger getCustomLogger() {
        return SellwildPrebid.customLogger;
    }
    ...
    public static void setCustomLogger(@NonNull PrebidLogger logger) {
        SellwildPrebid.customLogger = logger;
    }
    ...
    public static void checkGoogleMobileAdsCompatibility(@NonNull String googleAdsVersion) {
        int[] prebidVersion = parseVersion(SellwildPrebid.TESTED_GOOGLE_SDK_VERSION);
        ...
        if (prebidVersionBigger) {
            LogUtil.error("You should update GMA SDK version to " + SellwildPrebid.TESTED_GOOGLE_SDK_VERSION + " version that was tested with Prebid SDK (current version " + googleAdsVersion + ")");
        } else if (publisherVersionBigger) {
            LogUtil.error("The current version of Prebid SDK is not validated with your version of GMA SDK " + googleAdsVersion + " (Prebid SDK tested on " + SellwildPrebid.TESTED_GOOGLE_SDK_VERSION + "). Please update the Prebid SDK or post a ticket on the github.");
        }
    }

    /**
     * Sets full valid URL for the /status endpoint of the PBS.
     * Request to /status is sent when you call {@link SellwildPrebid#initializeSdk(Context, String, SdkInitializationListener)} )}.
     *
    ...
    public static void setIncludeWinnersFlag(boolean includeWinners) {
        SellwildPrebid.includeWinners = includeWinners;
    }
    ...
    public static boolean getIncludeWinnersFlag() {
        return SellwildPrebid.includeWinners;
    }
    ...
    public static boolean setIncludeBidderKeysFlag(boolean includeBidderKeys) {
        return SellwildPrebid.includeBidderKeys = includeBidderKeys;
    }
    ...
    public static boolean getIncludeBidderKeysFlag() {
        return SellwildPrebid.includeBidderKeys;
    }
    ...
    public static void setPbsConfig(PBSConfig pbsConfig) {
        SellwildPrebid.pbsConfig = pbsConfig;
    }
    ...
    public static void setCreativeFactoryTimeout(int creativeFactoryTimeout) {
        SellwildPrebid.creativeFactoryTimeout = creativeFactoryTimeout;
    }
    ...
    public static void setCreativeFactoryTimeoutPreRenderContent(int creativeFactoryTimeoutPreRenderContent) {
        SellwildPrebid.creativeFactoryTimeoutPreRenderContent = creativeFactoryTimeoutPreRenderContent;
    }
     ...
     */
    public static void registerPluginRenderer(SellwildPrebidPluginRenderer prebidMobilePluginRenderer) {
        SellwildPrebidPluginRegister.getInstance().registerPlugin(prebidMobilePluginRenderer);
    }

    /**
     * Remove plugin renderer. {@link #registerPluginRenderer(SellwildPrebidPluginRenderer)}
     */
    public static void unregisterPluginRenderer(SellwildPrebidPluginRenderer prebidMobilePluginRenderer) {
        SellwildPrebidPluginRegister.getInstance().unregisterPlugin(prebidMobilePluginRenderer);
    }

    /**
     * Return whether SDK already registered this renderer.
     */
    public static Boolean containsPluginRenderer(SellwildPrebidPluginRenderer prebidMobilePluginRenderer) {
        return SellwildPrebidPluginRegister.getInstance().containsPlugin(prebidMobilePluginRenderer);
    }
    ...
    public static void setDisableStatusCheck(boolean disableStatusCheck) {
        SellwildPrebid.disableStatusCheck = disableStatusCheck;
    }
