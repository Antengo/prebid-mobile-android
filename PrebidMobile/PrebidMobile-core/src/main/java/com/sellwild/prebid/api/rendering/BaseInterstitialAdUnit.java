...
public abstract class BaseInterstitialAdUnit {
    ...
    private SellwildPrebidInterstitialControllerInterface interstitialController;
    ...
    protected void loadPrebidAd() {
        SellwildPrebidPluginRenderer plugin = SellwildPrebidPluginRegister.getInstance().getPluginForPreferredRenderer(bidResponse);
        if (plugin != null) {
