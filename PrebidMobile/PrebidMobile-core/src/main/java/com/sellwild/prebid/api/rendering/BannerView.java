...
import com.sellwild.prebid.core.R;
...
import com.sellwild.prebid.rendering.bidding.interfaces.BannerEventHandler;
import com.sellwild.prebid.rendering.bidding.interfaces.StandaloneBannerEventHandler;
import com.sellwild.prebid.rendering.bidding.listeners.BannerEventListener;
...
import com.sellwild.prebid.rendering.utils.broadcast.ScreenStateReceiver;
import com.sellwild.prebid.rendering.utils.helpers.RenderingExceptionParser;
import com.sellwild.prebid.rendering.utils.helpers.VisibilityChecker;
import com.sellwild.prebid.rendering.views.webview.mraid.Views;
...
public class BannerView extends FrameLayout {
    ...
    public void destroy() {
        ...
        SellwildPrebidPluginRegister.getInstance().unregisterEventListener(adUnitConfig.getFingerprint());
    ...
    public void setPluginEventListener(PluginEventListener pluginEventListener) {
        SellwildPrebidPluginRegister.getInstance().registerEventListener(pluginEventListener, adUnitConfig.getFingerprint());
    }
    ...
    private void initPrebidRenderingSdk() {
        String hostUrl = SellwildPrebid.getPrebidServerHost().getHostUrl();
        if (!hostUrl.isEmpty()) {
            SellwildPrebid.initializeSdk(getContext(), hostUrl, null);
        }
    }
    ...
    private void displayPrebidView() {
        ...
        if (bidResponse.getPreferredPluginRendererName() == SellwildPrebidPluginRegister.PREBID_MOBILE_RENDERER_NAME) {
     ...
     * {@link com.sellwild.prebid.api.rendering.listeners.BannerViewListener#onAdLoaded(BannerView)}
