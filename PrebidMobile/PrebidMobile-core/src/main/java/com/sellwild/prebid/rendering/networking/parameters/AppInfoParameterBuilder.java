...
public class AppInfoParameterBuilder extends ParameterBuilder {
    ...
    public void appendBuilderParameters(AdRequestInput adRequestInput) {
        ...
        app.getPublisher().id = SellwildPrebid.getPrebidServerAccountId();
        ...
        app.getExt().put("prebid", Prebid.getJsonObjectForApp(BasicParameterBuilder.DISPLAY_MANAGER_VALUE, SellwildPrebid.SDK_VERSION));
