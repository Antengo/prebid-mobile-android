 ...
 * (it's created in {@link com.sellwild.prebid.SellwildPrebid#initializeSdk(Context, SdkInitializationListener)}).
...
public class UserConsentUtils {
    ...
    private static void doIfManagerExists(
        ...
        if (manager != null) {
            ...
            LogUtil.error(TAG, "You can't call " + method + "() before SellwildPrebid.initializeSdk().");
        }
    }
