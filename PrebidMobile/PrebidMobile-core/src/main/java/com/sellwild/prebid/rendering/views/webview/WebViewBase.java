...
import static com.sellwild.prebid.rendering.views.webview.AdWebViewClient.AdAssetsLoadedListener;
...
public class WebViewBase extends AdWebView implements AdAssetsLoadedListener {
    ...
    public void loadAd() {
         ...
         * via-javascript
         * ***/
        loadDataWithBaseURL(SellwildPrebid.SCHEME_HTTPS + "://" + domain + "/", adHTML, "text/html", "utf-8", null);
    }
