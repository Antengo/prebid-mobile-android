...
package com.sellwild.prebid.test.utils;
...
public class WhiteBox {
    ...
    public static <T> T getInternalState(Object target, String field) {
        ...
        try {
            Field f = com.sellwild.prebid.test.utils.WhiteBoxHelpers.getFieldFromHierarchy(c, field);
    ...
    public static Field field(Class<?> declaringClass, String fieldName) {
        return com.sellwild.prebid.test.utils.WhiteBoxHelpers.getFieldFromHierarchy(declaringClass, fieldName);
    }

    public static Method method(Class<?> declaringClass, String methodName, Class<?>... parameterTypes) {
        return com.sellwild.prebid.test.utils.WhiteBoxHelpers.getMethod(declaringClass, methodName, parameterTypes);
    }
}
